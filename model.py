...
if __name__ == '__main__':
    ...
    # model
    model = PixelCNN((3, 32, 32), 4, n_layers=5, use_resblock=True, color_conditioning=True, n_filters=120)
    ...
    # Data loader
    tranfomer = transforms.Compose([
        transforms.ToTensor()
    ])
    trainset = torchvision.datasets.CIFAR10(root='./data', train=True, transform=tranfomer)
    ...
    max_loss = float('inf')
    epochs = 10
    model_path = '/home/dungdv/PycharmProjects/pixel_cnn_plus/weight/model.pth'
    for epoch in range(epochs):
        ...
        for i, (images, _) in tqdm(enumerate(train_loader)):
            ...
            optimizer.step()
            if i % 10 == 0:
                print('Epochs: {}\tloss: {}'.format(epoch + 1, running_loss/(i+1)))
